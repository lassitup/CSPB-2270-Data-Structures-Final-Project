...
11. Porgram Demo - An extra Demo Resource to show how the program functions with a simple example
12. Project Proposal - Original Project Proposal submitted to the class
